...
(52, '59d9dceab50c5.jpg', 'Lemon drizzel cake', '<ul><li>Heat oven to 180C/fan 160C/gas 4.;225g softened unsalted butter and 225g caster sugar until pale and creamy, then add 4 eggs, one at a time, slowly mixing through. Sift in 225g flour, then add the finely grated zest of 1 lemon and;until well combined. Line a loaf tin (8 x 21cm) with greaseproof paper, then spoon in the mixture and level the top with a spoon.</li></ul>'),
...
INSERT INTO `signup` (`user_id`, `firstname`, `lastname`, `email`, `password`) 
VALUES (3, 'groot', 'iamgroot', 'iamgroot@gotg.com', 'iamgroot');
