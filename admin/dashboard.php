                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i>Foodmates <i class="caret"></i>
                ...
                <div class="span9" id="content">
                    <div class="row-fluid">
                        <div class="alert alert-success">
                            ...
                            <h4>Success</h4>
                        	you've successfully Logged in to the Main Frame Account.</div>
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
